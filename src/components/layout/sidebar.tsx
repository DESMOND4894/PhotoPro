...
export function Sidebar() {
  ...
  useEffect(() => {
    ...
    fetchConnections();
  }, [pathname]); // refetch when navigating (e.g. after connecting)
    ...
    <>
      ...
      <nav className="flex-1 px-5 py-6 space-y-2">
        ...
        <a
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors text-slate-300 hover:bg-slate-800 hover:text-white"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-5 py-4 border-t border-slate-700">
        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">
          {facebookConnection || instagramConnection ? "Connected Accounts" : "No Accounts Connected"}
        </p>
        {facebookConnection || instagramConnection ? (
          <div className="space-y-2.5">
            {facebookConnection && (
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  <p className="text-sm text-white truncate">{facebookConnection.platform_name || "Facebook Page"}</p>
            ...
            {instagramConnection && (
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  <p className="text-sm text-white truncate">{instagramConnection.platform_name || "Instagram Business"}</p>
          ...
          <p className="text-xs text-slate-500">Connect via the Connect page</p>
        )}
      </div>
